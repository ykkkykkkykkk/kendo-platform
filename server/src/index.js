...
import adminBracketRouter from './routes/admin-bracket.js';
import adminUsersRouter  from './routes/admin-users.js';
import { adminVideoRouter, myVideoRouter } from './routes/playerVideos.js';
import { myGearRouter } from './routes/myGear.js';
import bambooRouter from './routes/bamboo.js';
import adminBambooRouter from './routes/admin-bamboo.js';
...
app.use('/api/me',                             myGearRouter);
app.use('/api',                                bambooRouter);
app.use('/api/admin',       adminLimiter,      adminBambooRouter);
